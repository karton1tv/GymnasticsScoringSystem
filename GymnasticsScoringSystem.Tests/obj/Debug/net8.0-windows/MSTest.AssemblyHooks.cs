...
[GeneratedCode("Reqnroll", "2.2.0")]
[TestClass]
public class GymnasticsScoringSystem_Tests_MSTestAssemblyHooks
{
    [AssemblyInitialize]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static async Task AssemblyInitializeAsync(TestContext testContext)
    {
        var currentAssembly = typeof(GymnasticsScoringSystem_Tests_MSTestAssemblyHooks).Assembly;
